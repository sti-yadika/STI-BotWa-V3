...
require('./kyami.js')
nocache('../kyami.js', module => console.log(color('[ CHANGE ]', 'green'), color(`'${module}'`, 'green'), 'Updated'))
require('./index.js')
...
require('./kyami')(NanoBotz, m, chatUpdate, store)
} catch (err) {
console.log(err)}})
...
welcome(iswel, isLeft, NanoBotz, anu)
    ...
    async function getMessage(key){
        ...
        return {
            conversation: "Mannn Bot In Here"
        }
    }
